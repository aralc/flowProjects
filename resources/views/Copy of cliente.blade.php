                    ...
                    <input type="hidden" name="_token" value="{{{csrf_token()}}}">
                    	<!-- Código -->
                        	...
                        	<label class="control-label col-lg-2" for="title">Código de Cliente</label>
                        		<div class="col-lg-10">
                          		<input type="numeric" class="form-control" name="clienteCodigo" id="CodigoEmp" maxlength="4" size="4" required>
                        		</div>
                      		</div>
                            ...
                            <!-- Content -->
                      		...
                      		<div class="form-group">
                        		<label class="control-label col-lg-2" for="CNPJ">Endereco</label>
                        			<div class="col-lg-10">
                        			<input type="numeric" class="form-control" name="clienteEndereco" id="CnpjEmp" maxlength="30" size="30" required>
                          			<!--  <textarea class="form-control" id="content"></textarea> -->
                        			</div>
                      		</div>
                      		...
                      		<div class="form-group">
                        		<label class="control-label col-lg-2" for="CNPJ">Bairro</label>
                        			<div class="col-lg-10">
                        			<input type="numeric" class="form-control" name="clienteBairro" id="CnpjEmp" maxlength="20" size="20" required>
                          			<!--  <textarea class="form-control" id="content"></textarea> -->
                        			</div>
                      		</div>
                      ...
                      <!-- Tags -->
                        	...
                        	<label class="control-label col-lg-2" for="tags">telefone</label>
                        		<div class="col-lg-10">
                          		<input type="text" class="form-control" id="emailEmp" name="clienteTelefone">
                        	</div>
                      		</div>
